...
<div id="container" style="width:100%;height:100%;">
    ...
    <div id="content" style="height:200px;width:85%;height:70%;float:left;">
        ...
        <form id="userAction_save_do" name="Form1" action="noticeServlet?action=addNotice" method="post">
            &nbsp;
            <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
                <tr>
                    <td align="center" bgColor="#afd1f3" colSpan="4"
                        height="26"><strong><STRONG>添加公告</STRONG> </strong>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td bgColor="#ffffff" colSpan="3">
                        ...
                        <textarea name="description" cols="30" rows="3" style="WIDTH: 96%" id="description" ></textarea>
                    </td>
                </tr>
