...
/*        #loginMessage{
    ...
    <script type="text/javascript">
        window.onload=function () {
            var second = 5;
            //2定义一个方法，获取span标签，修改span标签体内容，时间...
...
<%--<div id="loginMessage">欢迎您：${sessionScope.username}</div>--%>
...
<div id="registSuccessDiv">
    ...
    <span style="color: red; font-weight: bold;">登录成功，欢迎使用！</span> <br><br>
    <span style="color: cornflowerblue; font-weight: bold;" id="time" >5</span>
    <span style="color: cornflowerblue;">秒后自动为您跳转回首页</span>
</div>
